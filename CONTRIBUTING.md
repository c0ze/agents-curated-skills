...
```bash
# 1. Fork and clone
git clone https://github.com/YOUR-USERNAME/agents-curated-skills.git
cd agents-curated-skills
...
- **Questions?** Open a [Discussion](https://github.com/c0ze/agents-curated-skills/discussions)
- **Stuck?** Open an [Issue](https://github.com/c0ze/agents-curated-skills/issues)
- **Want feedback?** Open a [Draft Pull Request](https://github.com/c0ze/agents-curated-skills/pulls)

---

## Recognition

All contributors are recognized in our [Contributors](https://github.com/c0ze/agents-curated-skills/graphs/contributors) page.
