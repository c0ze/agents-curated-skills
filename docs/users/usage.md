...
3. Try the explicit path: `npx agents-curated-skills --claude` (or `--cursor`, `--gemini`, etc.)
...
3. [Open an issue](https://github.com/c0ze/agents-curated-skills/issues) with details
...
3. [Open a Discussion](https://github.com/c0ze/agents-curated-skills/discussions)
4. [File an Issue](https://github.com/c0ze/agents-curated-skills/issues) to help us improve this guide!
