...
**Bạn có thắc mắc?** Bạn không hề cô đơn! Dưới đây là câu trả lời cho những câu hỏi thường gặp nhất về Agents Curated Skills.
...
```bash
@brainstorming giúp tôi thiết kế phần này, sau đó dùng @doc-coauthoring để tạo danh sách nhiệm vụ.
```
...
Hãy [Mở một issue](https://github.com/c0ze/agents-curated-skills/issues)!  
Vui lòng gửi kèm:
...
- Sử dụng `@debugging-strategies` khi gặp lỗi khó nhằn.
- Thử `@test-driven-development` để code có chất lượng tốt hơn.
- Xem `docs/contributors/skill-anatomy.md` để tự tạo kỹ năng của riêng bạn.

**Vẫn còn thắc mắc?** [Mở một cuộc thảo luận (Discussion)](https://github.com/c0ze/agents-curated-skills/discussions) và chúng tôi sẽ giúp bạn! 🙌
