...
- 🎯 [质量标准](quality-bar.md)
- 🤝 [社区讨论](https://github.com/c0ze/agents-curated-skills/discussions)
- 🐛 [问题报告](https://github.com/c0ze/agents-curated-skills/issues)
...
感谢您考虑为Agents Curated Skills贡献！使用这个模板，您可以帮助创建高质量、一致性的技能，让整个社区受益。
