# Agents Curated Skills 入门指南 (V7.0.0)
...
默认情况下克隆到`~/.gemini/antigravity/skills`。使用`--cursor`、`--claude`、`--gemini`、`--codex`或`--kiro`为特定工具安装，或使用`--path <dir>`自定义位置。运行`npx agents-curated-skills --help`查看详情。

如果看到404错误，使用：`npx github:c0ze/agents-curated-skills`
...
- 🐛 [报告问题](https://github.com/c0ze/agents-curated-skills/issues) - 发现bug请报告
- 💡 [功能建议](https://github.com/c0ze/agents-curated-skills/issues/new?template=feature_request.md) - 建议新功能
